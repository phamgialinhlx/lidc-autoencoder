...
from src.data.datasets import LIDC2DDataset

class LIDC2DDataModule(LightningDataModule):
    def __init__(
        self,
...
@hydra.main(
    version_base="1.3", config_path="../../configs/data", config_name="lidc2d.yaml"
)
def main(cfg: DictConfig):
    print(cfg)
    cfg.image_size = 128
    cfg.train_val_test_split = (80, 10, 10)
    cfg.nodules_only = True
    cfg.batch_size = 16
    # cfg.data_dir = "/mnt/work/Code/LIDC-IDRI-Preprocessing/data/"
    datamodule: LIDC2DDataModule = hydra.utils.instantiate(cfg)
    datamodule.setup()

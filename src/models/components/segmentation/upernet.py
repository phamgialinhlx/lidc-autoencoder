...
class UPerNet(nn.Module):
    ...
    def forward(self, x):
        ...
        print(resnet_features.keys())
        print(resnet_features['resnet_layer1'].shape)
        print(resnet_features['resnet_layer2'].shape)
        print(resnet_features['resnet_layer3'].shape)
        print(resnet_features['resnet_layer4'].shape)
...
if __name__ == "__main__":
    img = torch.rand(1, 3, 128, 128).float()
